...
// Progress, In Review is the human-approval gate, and every ticket ends in one of the
...
export const GATE_STATES = ["In Review"];
 ...
 * Progress, the session's result file writes In Review, a review verdict writes Done — and each
