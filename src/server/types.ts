...
export interface SessionMeta {
  kind: "lime" | "custom" | "rebase" | "shell"; // "lime" = ticket-lifecycle; "custom" = standalone claude; "rebase" = one-off To-QA rebase; "shell" = plain login-shell terminal ($SHELL, or bash)
