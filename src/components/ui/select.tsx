"use client";
// shadcn/ui — Select (Radix). Kept close to upstream so it can be re-generated; the
// only local edits are Mojito's radii/typography and the z-index note below.
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // z-200: the sheets sit at 100 and the docs overlay at 120 (see globals.css),
        // and every one of these lives inside a sheet.
        "relative z-[200] max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-input bg-popover text-popover-foreground shadow-[var(--shadow)]",
